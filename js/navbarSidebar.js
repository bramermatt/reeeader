document.addEventListener("DOMContentLoaded", function() {
        ...
        <ul id="iconLinks">
          ...
          <li class="dropdown">
            ...
            <div class="dropdown-content">
              <a href="${basePath}pages/books.html">Books*</a>
              <a href="${basePath}pages/authors.html">Authors*</a>
              <a href="${basePath}pages/series.html">Series*</a>
              <a href="${basePath}pages/genres.html">Genres*</a>
            </div>
          </li>
          <li class="dropdown">
            <a href="javascript:void(0)" class="dropdown-toggle">
    ...
    const footerHTML = `
        ...
        <img src="reeeader-footer-man.png" alt="">
    `
